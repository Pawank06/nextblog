...
const BlogArticle = async({params}: {params: {slug: string}} )=> {
  ...
  return (
    <div className="mt-8">
         <h1>
       <span className="block text-base text-center text-primary font-semibold tracking-wide">Jan next - blog</span>
       <span className="mt-2 block text-3xl text-center font-bold leading-8 tracking-tight sm:text-4xl">{data.title}</span>
    </h1>
    <Image src={urlFor(data.titleImage).url()} width={800} height={800} alt="image"
    priority
